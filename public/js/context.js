...
function createDomRefs() {
    return {
        ...
        globalEventToggleBtn: requireElement("global-event-toggle-btn"),
        authAccountToggleBtn: requireElement("auth-account-toggle-btn"),
...
function createInitialState() {
    return {
        ...
        activeTab: "staff",
        isNavMenuOpen: false,
        isEventCardCollapsed: false,
        isAccessCardCollapsed: false,

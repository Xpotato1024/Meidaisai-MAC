...
import { createDefaultReceptionLayout, formatReceptionWidthRatio, getReceptionCardGridSpan, getReceptionWidthOptions, normalizeReceptionLayoutConfig } from "./reception-layout.js";
let editorRoot = null;
...
function ReceptionLayoutEditor({ rooms, layout, onChange }) {
    ...
    return (_jsxs("div", { className: "admin-layout-editor", children: [_jsxs("div", { className: "admin-layout-editor-toolbar", children: [_jsxs("div", { children: [_jsx("p", { className: "admin-layout-editor-kicker", children: "Edit Mode" }), _jsx("p", { className: "admin-layout-editor-copy", children: "\u30C9\u30E9\u30C3\u30B0\u3067\u4E26\u3073\u66FF\u3048\u3001\u30AB\u30FC\u30C9\u5E45\u3068\u30EC\u30FC\u30F3\u5217\u6570\u3092\u8ABF\u6574\u3057\u307E\u3059\u3002\u53D7\u4ED8\u753B\u9762\u306F\u3053\u306E\u9806\u5E8F\u3067\u81EA\u52D5\u914D\u7F6E\u3055\u308C\u307E\u3059\u3002" })] }), _jsx("button", { type: "button", className: "admin-layout-editor-reset", onClick: handleReset, children: "\u521D\u671F\u914D\u7F6E\u306B\u623B\u3059" })] }), _jsxs("div", { className: "admin-layout-editor-canvas", children: [orderedRooms.map((item) => {

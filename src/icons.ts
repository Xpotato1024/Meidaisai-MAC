function buildOrbIcon(primary: string, highlight: string, symbolMarkup: string, extraClass = ""): string {
    return `
...
export const STATUS_ICON_SVGS = {
    available: buildOrbIcon(
        "#10b981",
        "#6ee7b7",
        '<path d="M8.6 12.4 10.95 14.7 15.45 9.55" stroke="#ffffff" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round" />'
    ),
    occupied: buildOrbIcon(
        "#ef4444",
        "#fda4af",
        '<path d="m9.15 9.15 5.7 5.7m0-5.7-5.7 5.7" stroke="#ffffff" stroke-width="2.3" stroke-linecap="round" />'
    ),
    preparing: buildOrbIcon(
        "#f59e0b",
        "#fde68a",
        '<path d="M12 7v3m0 4v3m5-5h-3m-4 0H7m8.2-3.2-2.1 2.1m-2.2 2.2-2.1 2.1m0-6.4 2.1 2.1m2.2 2.2 2.1 2.1" stroke="#ffffff" stroke-width="2.05" stroke-linecap="round" />'
    ),
    paused: buildOrbIcon(
        "#64748b",
        "#cbd5e1",
        '<path d="M10 8.3v7.4m4-7.4v7.4" stroke="#ffffff" stroke-width="2.35" stroke-linecap="round" />'
    ),
    receptionAvailable: buildOrbIcon(
        "#14b8a6",
        "#99f6e4",
        '<path d="M7.45 12.25 10.15 15l6.45-6.65" stroke="#ffffff" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round" />'
    ),
    guiding: buildOrbIcon(
        "#2563eb",
        "#93c5fd",
        '<path d="M7 12h8.25m0 0-3.25-3.25M15.25 12 12 15.25" stroke="#ffffff" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" />'
    )
};

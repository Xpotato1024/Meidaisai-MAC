...
export interface ParsedMemberDirectoryRow {
    emailKey: string;
    email: string;
    displayName: string;
    grade: string | null;
...
export interface ParsedMemberDirectoryCsv {
    entries: ParsedMemberDirectoryRow[];
...
function getHeaderIndex(headers: string[], aliases: readonly string[], label: string): number {
...
export function parseMemberDirectoryCsv(text: string): ParsedMemberDirectoryCsv {
    ...
    const entries: ParsedMemberDirectoryRow[] = [];

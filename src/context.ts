...
function createDomRefs(): DomRefs {
    return {
        ...
        authManualRequestForm: requireElement("auth-manual-request-form"),
        authManualDisplayNameInput: requireElement("auth-manual-display-name-input"),
        authManualRequestSubmitBtn: requireElement("auth-manual-request-submit-btn"),
        tabsMenuToggle: requireElement("tabs-menu-toggle"),
        tabsMenuLabel: requireElement("tabs-menu-label"),
        ...
        authAccountCard: requireElement("auth-account-card"),
        statusBannerToggleBtn: requireElement("status-banner-toggle-btn"),
        ...
        summarySection: requireElement("summary-section"),
        summaryToggleBtn: requireElement("summary-toggle-btn"),
...
function createInitialState(): AppState {
    return {
        ...
        activeTab: "staff",
        isNavMenuOpen: false,
        isStatusBannerCollapsed: false,
        isSummaryCollapsed: false,
        memberSortMode: "grade-asc",
        ...
        accessMembersCache: [],
        accessRequestsCache: [],
        waitingGroupLocalTargets: {},
        waitingGroupInFlightTargets: {},
        waitingGroupSyncTimers: {},
        waitingGroupSyncInFlight: {},
        isDbMigrating: false,
        registryCache: [],
